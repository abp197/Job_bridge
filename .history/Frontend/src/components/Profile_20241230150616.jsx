...
const Profile = () => {
    ...
    return (
        <div className="  min-h-screen " style={{ backgroundImage: 'url("https://static.vecteezy.com/system/resources/thumbnails/001/813/556/small/light-blue-texture-in-rectangular-style-vector.jpg")' }}>
            <Navbar />
