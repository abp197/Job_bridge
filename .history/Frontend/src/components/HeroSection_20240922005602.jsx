                ...
                <div className='flex flex-col gap-5 my-10'>
                    ...
                    <p className='text-white'>Welcome to JobBridge, your ultimate job portal designed to connect talent with opportunity. Explore a diverse
                         range of job listings tailored to your skills and aspirations, whether you're a job seeker or a recruiter. With an intuitive interface
                          and personalized features, we empower you to find the perfect match in today's competitive job market. Join us today and take the next step in your career journey!</p>
