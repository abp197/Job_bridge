...
const Signup = () => {
  ...
  return (
    <div className="bg-cover bg-center" style={{ backgroundImage: 'url("https://testedrecruits.com/wp-content/uploads/home-section02-bg.jpg")' }}>
      <Navbar />
      <div className='flex items-center justify-center min-h-screen'>
        <form onSubmit={submitHandler} className='bg-white border border-gray-200 rounded-lg shadow-lg p-8 my-10 max-w-md w-full'>
          ...
          {/* Submit Button */}
          {loading ? (
            <Button variant="contained" fullWidth disabled className="bg-gray-600 mt">
