...
const AdminJobs = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-gray-100 to-indigo-50" style={{ backgroundImage: 'url("https://img.freepik.com/free-photo/flat-lay-stationary-arrangement-desk-with-copy-space-coffee_23-2148404490.jpg?t=st=1735562941~exp=1735566541~hmac=8cc940bfc54a11ef0f470897d83d2330f14a7ed79166fd5519f9f3434cbf6f09&w=996")' }}>
