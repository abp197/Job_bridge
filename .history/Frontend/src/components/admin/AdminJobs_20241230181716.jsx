...
const AdminJobs = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-gray-100 to-indigo-50" style={{ backgroundImage: 'url("https://img.freepik.com/free-photo/office-supplies_23-2148103964.jpg?ga=GA1.1.1564564166.1725995450&semt=ais_hybrid")' }}>
