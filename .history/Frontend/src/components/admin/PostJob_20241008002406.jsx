...
const PostJob = () => {
    ...
    return (
        <div className="min-h-screen bg-cover bg-center flex items-center justify-center" 
            style={{ backgroundImage: `url('/path-to-your-image/job-post-background.png')` }}>
            <Navbar />
            <div className='p-8 max-w-4xl bg-white bg-opacity-90 rounded-lg shadow-xl transform transition hover:scale-105'>
                <form onSubmit={submitHandler} className='p-8 border border-gray-200 rounded-md'>
