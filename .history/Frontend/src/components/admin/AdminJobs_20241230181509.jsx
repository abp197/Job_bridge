...
const AdminJobs = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-gray-100 to-indigo-50" style={{ backgroundImage: 'url("https://media.istockphoto.com/id/1455906418/photo/man-using-laptop-showing-online-job-search-career-search-ideas-recruitment-hr-search-form.jpg?s=612x612&w=0&k=20&c=HpIzbY_3drlZwAMAKMI9FMX-Xg3V-YTCO8apxFlrVrc=")' }}>
