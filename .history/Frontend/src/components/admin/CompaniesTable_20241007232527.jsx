...
const CompaniesTable = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
            <div
                className="relative w-full max-w-4xl mx-auto overflow-hidden bg-cover bg-center rounded-lg shadow-xl"
                style={{ backgroundImage: `url('https://files.oaiusercontent.com/file-g2ssRjsascrimwiAg3hjDOlG?se=2024-10-07T17%3A56%3A32Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D3845e81c-5370-41e5-b07a-d1fca715b288.webp&sig=nMenTyJQIVuPxcMKFf0tZXevSlN8prwGY6Ow1/Dp9Ok%3D')` }} // Update the path if necessary
            >
                <div className="absolute inset-0 bg-black opacity-30"></div> {/* Dark overlay */}
                <div className="relative z-10 p-6">
                    <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-lg">
                        <caption className="text-left p-4 text-gray-600">
