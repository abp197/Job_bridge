...
const PostJob = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                alert(res.data.message); // Notification logic can be customized here
                navigate("/admin/jobs");
            }
        } catch (error) {
            alert(error.response?.data?.message || "An error occurred."); // Notification logic can be customized here
        } finally {
            setLoading(false);
        }
    };
