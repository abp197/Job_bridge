...
const AdminJobs = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-gray-100 to-indigo-50" style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRn5DiSDIrfNidy70jaemG6widLiH8TPfReBw&s")' }}>
            <Navbar />
      <Navbar />
