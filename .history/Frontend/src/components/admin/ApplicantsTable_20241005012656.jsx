...
const ApplicantsTable = () => {
    ...
    const [isPopoverOpen, setIsPopoverOpen] = useState(null); // Track which popover is open
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow">
                ...
                <tbody>
                    {applicants && applicants.applications?.length > 0 ? (
                            ...
                            <tr key={item._id} className="border-t">
                                ...
                                <td className="p-3 text-right">
                                    <Popover
                                        ...
                                        position={['top', 'left', 'right']} // Position of the popover
                                        onClickOutside={() => setIsPopoverOpen(null)} // Close on outside click
                                        content={(
                        ...
                        <tr>
                            <td colSpan={6} className="text-center p-4">No applicants found.</td>
                        </tr>
                    )}
                </tbody>
            </table>
