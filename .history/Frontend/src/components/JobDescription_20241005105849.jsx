...
const JobDescription = () => {
    ...
    const applyJobHandler = async () => {
        const data = {
            jobId: jobId,  // Ensure jobId is properly assigned
            applicantId: applicantId,  // Ensure applicantId is set
            resume: resumeUrl // Make sure the resume URL is correct
        };
    
        console.log('Payload:', data); // Log payload to inspect the content
    
        try {
            const res = await axios.post(`${APPLICATION_API_END_POINT}/apply`, data, { withCredentials: true });
