...
const Profile = () => {
    ...
    return (
        <div className="  min-h-screen " style={{ backgroundImage: 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRn5DiSDIrfNidy70jaemG6widLiH8TPfReBw&s")' }}>
            <Navbar />
            <div className="max-w-4xl mx-auto bg-white border border-gray-200 rounded-2xl shadow-lg mt-10 p-8">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 border bg-slate-300 border-gray-300 rounded-md px-4 py-2 hover:bg-gray-50 transition"
                    >
                        <Pen size={20} />
                        <span>Edit</span>
                    </button>
            ...
            <div className="max-w-4xl mx-auto bg-slate-200 rounded-2xl shadow-lg mt-8 p-8">
