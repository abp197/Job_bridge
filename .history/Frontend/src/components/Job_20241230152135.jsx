    ...
    return (
        <Paper 
            ...
            sx={{ 
                ...
                margin: 'auto',
                minHeight: 350 // Ensures consistent box size
            }}
        >
            <Box 
                display="flex" 
            ...
            >
                ...
                <Box textAlign={{ xs: 'center', sm: 'left' }}>
                    <Typography variant="h6" noWrap>{job?.company?.name}</Typography>
                    <Typography variant="body2" color="text.secondary" noWrap>India</Typography>
                </Box>
            </Box>
