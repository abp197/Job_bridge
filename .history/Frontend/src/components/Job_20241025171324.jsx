    ...
    return (
        <div className="p-5 rounded-md shadow-lg bg-white border border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl">
            ...
            <div className="flex items-center gap-2 mt-4">
                <span className="bg-blue-100 text-blue-700 font-bold py-1 px-2 rounded">{job?.position || 0} Positions</span>
                <span className="bg-[#df5d40] text-white font-bold py-1 px-2 rounded">{job?.jobType || "N/A"}</span>
                <span className="bg-[#455de8] text-white font-bold py-1 px-2 rounded">{job?.salary || "N/A"} LPA</span>
            </div>
