...
const LatestJobCards = ({ job }) => {
    ...
    return (
        <div
            ...
            className="p-4 sm:p-5 rounded-md shadow-md sm:shadow-xl bg-white border border-gray-200 cursor-pointer transition-transform transform hover:scale-105 hover:shadow-2xl max-w-xs sm:max-w-sm w-full"
        >
            <div>
